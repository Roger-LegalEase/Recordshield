  ...
  return (
    <main className="panel">
      ...
      <p>
        ...
        events, summaries, support notes, and audit records needed to operate RecordShield.
      </p>
      ...
      <p>
        Stripe processes payments. OpenAI may be used to generate clear summaries from normalized, minimized report
        data.
      </p>
