...
export default function TermsPage() {
  return (
    <main className="panel">
      ...
      <p>
        Users must request checks only about themselves, provide accurate information in provider-hosted flows, verify
        results, and consult a qualified attorney for legal advice.
      </p>
