...
export const envSchema = z
  .object({
    ...
    RECORDSHIELD_BASIC_PRICE_CENTS: priceCents.default(14_900),
    ...
    STRIPE_PRICE_RECORDSHIELD_PRIVATE_REVIEW: optionalNonEmpty,
    ...
    LEGALEASE_OS_EVENTS_ENABLED: z.enum(["true", "false"]).default("false"),
    LEGALEASE_OS_EVENTS_ENDPOINT: z.string().url().optional(),
    LEGALEASE_OS_EVENTS_SECRET: optionalNonEmpty,
...
export function normalizeEnv(input: Record<string, string | undefined>): Record<string, string | undefined> {
  ...
  return {
    ...
    STRIPE_PRICE_RECORDSHIELD_PRIVATE_REVIEW:
      input.STRIPE_PRICE_RECORDSHIELD_PRIVATE_REVIEW ?? input.STRIPE_PRICE_RECORD_CHECK,
